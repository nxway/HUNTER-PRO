...
# Пусто — значит без ограничения по региону, работаем по всей России.
# Впишите коды сюда (или через панель настроек), если захотите сузить —
# например TARGET_REGIONS = [77, 50, 78] — только Москва/МО/СПб.
