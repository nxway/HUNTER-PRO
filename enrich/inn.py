...
# Сначала длинные формы, потом короткие — иначе "публичное акционерное
# общество" срежется только частично ("акционерное общество"), а
# "публичное" останется мусором. Реальные названия из деклараций ФСА
# приходят полной формой ("ОБЩЕСТВО С ОГРАНИЧЕННОЙ ОТВЕТСТВЕННОСТЬЮ"), а
# не только сокращением "ООО" — без длинных форм здесь сверка с сайтами
# компаний (почти всегда пишут сокращённо) почти никогда бы не срабатывала.
